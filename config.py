...
class Config(object):
    ...
    MONGO_DB_URI = environ.get('MONGO_DB_URI', "mongodb+srv://kalawativerma80:haremdbforbot@cluster0.vxnio.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
