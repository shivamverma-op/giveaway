...
class Config(object):
    ...
    MONGO_DB_URI = environ.get('MONGO_DB_URI', "mongodb+srv://kalawativerma80:CUhwW7zAu2RA900S@cluster0.vxnio.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
